...
def structured(title,description,url,image='assets/images/logo-280.webp'):
    data={'@context':'https://schema.org','@type':'WebPage','name':title,'description':description,'url':url,'isPartOf':{'@type':'WebSite','name':'Australian Hazaras','url':'https://baratalighulamreza.github.io/hazaraandhazaragi/'},'primaryImageOfPage':{'@type':'ImageObject','url':image}}
...
def build():
    ...
    base='https://baratalighulamreza.github.io/hazaraandhazaragi/'
